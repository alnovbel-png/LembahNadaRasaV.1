...
export const GAME_DIALOGUES: Record<string, DialogueNode> = {
  ...
  kiki_dismiss: {
    ...
    speakerRole: 'Tupai Pos Cilik',
    portrait: 'squirrel',
    text: 'Huuu... jangan marahi aku. Aku jadi makin takut...',
  ...
  kiki_validate: {
    ...
    speakerRole: 'Tupai Pos Cilik',
    portrait: 'squirrel',
    text: 'Kamu tidak memarahiku? Tapi jantungku masih berdebar kencang. Aku masih merasa takut...',
    nextId: 'kiki_validate_options',
  },
  kiki_validate_options: {
    id: 'kiki_validate_options',
    speaker: 'Kiki',
    speakerRole: 'Tupai Pos Cilik',
    portrait: 'squirrel',
    text: 'Terima kasih mau membantuku, Ezzel! Tapi tubuhku masih gemetar. Ajari aku cara agar bisa tenang dulu ya!',
    thoughtBubble: 'Kalau sudah tenang, kita pasti bisa mengumpulkan semua surat itu bersama-sama...',
    emotionAura: 'cemas',
    choices: [
      {
  ...
  kiki_calm_options: {
    ...
    speakerRole: 'Tupai Pos Cilik',
    portrait: 'squirrel',
    text: 'Terima kasih sudah peduli padaku, Ezzel. Tubuhku masih gemetar dan panik. Bagaimana cara agar aku tenang?',
  ...
  ranu_locked_need_kiki: {
    ...
    portrait: 'old_man',
    text: 'Eits, tunggu dulu! Tolong bantu tupai Kiki di alun-alun terlebih dahulu. Kalau Kiki sudah tenang, barulah temui aku di jembatan ini!',
  ...
  tower_locked_need_gear: {
    ...
    text: 'Pintu menara ini terkunci! Roda Gigi Emas masih dibawa oleh Bimo di hutan. Temui Bimo dulu untuk meluruskan salah paham ini!',
    thoughtBubble: 'Menara ini membutuhkan Roda Gigi Harmoni dari Bimo yang telah berani menghadapi ketakutannya...',
    emotionAura: 'kecewa',
    choices: [
      {
        id: 'tower_locked_c1',
        text: 'Aku mengerti! Aku akan segera mencari Bimo di Hutan Sunyi untuk meluruskan salah paham ini!',
        impactScore: 10,
  ...
  tower_locked_ack: {
    ...
    speakerRole: 'Monumen Harmoni',
    portrait: 'clock_tower',
    text: 'Pintu menara ini akan terbuka begitu kamu meluruskan salah paham dan membawa Roda Gigi Harmoni dari Bimo di Misi 3!',
    emotionAura: 'tenang',
  },
  ...
  kiki_remind_bridge: {
    ...
    speakerRole: 'Tupai Pos Cilik',
    portrait: 'squirrel',
    text: 'Ciiit! Terima kasih, Ezzel! Alun-Alun sudah ceria lagi. Sekarang ayo temui Kakek Ranu di jembatan sebelah timur.',
  ...
  ranu_remind_bimo: {
    ...
    portrait: 'old_man',
    text: 'Jembatan kayu sudah terbuka! Sekarang seberangilah dan temui Bimo di hutan. Sampaikan bahwa Kakek tidak marah padanya.',
    thoughtBubble: 'Bimo anak yang baik dan berbakat, bentakan kakek pasti membuatnya sangat takut...',
    emotionAura: 'tenang',
  },
  ...
  ranu_intro: {
    ...
    portrait: 'old_man',
    text: 'GRRR! Mau apa kalian ke sini?! Jembatan ini KUTUTUP! Pulanglah sana, jangan ganggu aku bekerja!',
    thoughtBubble: 'Semua orang hanya datang padaku saat ada yang rusak... Begitu tua dan lamban, aku ditinggalkan sendirian...',
    emotionAura: 'marah',
    choices: [
      {
        id: 'ranu_c1',
        text: 'Kakek pasti lelah bekerja merawat jembatan sendirian. Kami sangat berterima kasih atas kerja keras Kakek.',
        impactScore: 20,
      ...
      {
        id: 'ranu_c2',
        text: 'Kami tidak bermaksud mengganggu, Kek. Kami ingin menyeberang untuk menolong warga desa yang terkurung kabut.',
        impactScore: 15,
  ...
  ranu_path_empathy_3: {
    ...
    speakerRole: 'Tukang Kayu Desa',
    portrait: 'old_man',
    text: 'Terima kasih telah mendengar hatiku, Ezzel. Terimalah kunci jembatan ini. Tolong temui muridku, Bimo, di seberang jembatan. Sampaikan bahwa Kakek tidak marah padanya. Kakek sangat menunggunya pulang!',
  },
  ...
  ranu_path_logic: {
    ...
    speakerRole: 'Tukang Kayu Desa',
    portrait: 'old_man',
    text: 'Hmm... Jadi kalian bukan datang untuk mengotori jembatanku? Kalian sungguh-sungguh ingin menolong warga desa yang sedang kesulitan?',
  ...
  ranu_path_logic_2: {
    ...
    speakerRole: 'Tukang Kayu Desa',
    portrait: 'old_man',
    text: 'Baiklah, jembatan kubuka untuk kalian! Bawalah surat izin ini. Tolong cari muridku, Bimo, di seberang jembatan. Katakan padanya bahwa Kakek tidak marah dan menunggunya pulang.',
    triggerColorRestoreZone: 'bridge',
    triggerQuestProgress: 'quest_bridge',
  ...
  bimo_intro: {
    ...
    speakerRole: 'Murid Pembuat Jam (Kelas 4)',
    portrait: 'boy_glasses',
    text: 'Huwaaa! Jangan dekati aku, Ezzel! Tadi pagi Kakek Ranu membentakku. Kakek pasti membenciku! Aku takut dan lari membawa Roda Gigi ini ke hutan. Sekarang aku merasa bersalah...',
    thoughtBubble: 'Kakek Ranu pasti marah padaku... Aku takut dicap anak nakal...',
    emotionAura: 'sedih',
    choices: [
      {
        id: 'bimo_c1',
        text: 'Kakek Ranu tidak membencimu, Bimo. Beliau justru menitipkan pesan bahwa bentakannya tadi karena lelah, dan beliau sangat menyayangimu.',
        impactScore: 20,
        resultDialogueId: 'bimo_ranu_praise',
      },
      {
        id: 'bimo_c2',
        text: 'Membuat kekeliruan saat belajar itu wajar, Bimo. Satu kesalahan tidak membuatmu jadi anak buruk. Ayo kita perbaiki bersama!',
        impactScore: 20,
        resultDialogueId: 'bimo_growth_mindset',
      },
      {
        id: 'bimo_c3',
        text: 'Makanya jangan melarikan diri sambil membawa roda gigi jam! Kamu bikin semua orang panik!',
        impactScore: -10,
  ...
  bimo_shame: {
    ...
    speakerRole: 'Murid Pembuat Jam (Kelas 4)',
    portrait: 'boy_glasses',
    text: 'Huwaaa! Semua orang pasti menyalahkanku! Aku tidak mau bicara lagi!',
    isWrongFeedback: true,
    nextId: 'bimo_intro',
  },
  bimo_ranu_praise: {
    ...
    speakerRole: 'Murid Pembuat Jam (Kelas 4)',
    portrait: 'boy_glasses',
    text: 'Benarkah Kakek Ranu berkata begitu? Jadi Kakek tidak membenciku? Aku mengira Kakek sangat marah. Ternyata itu semua hanya salah paham...',
  ...
  bimo_growth_mindset: {
    ...
    speakerRole: 'Murid Pembuat Jam (Kelas 4)',
    portrait: 'boy_glasses',
    text: 'Terima kasih, Ezzel! Perkataanmu membuatku lega. Membuat kesalahan bukan berarti kita bodoh, tetapi tanda bahwa kita sedang belajar dan berusaha!',
    nextId: 'bimo_growth_mindset_2',
  },
  ...
  tower_intro: {
    ...
    text: 'Berhenti di sana! Mengapa kalian memulihkan desa ini? Bukankah semua orang hanya sibuk sendiri?',
  ...
  tower_empathy_twist: {
    ...
    text: 'Namaku Nenek Wilis. Aku bukan monster. Kabut abu-abu ini datang karena kita sering salah paham dan lupa saling mendengarkan.',
  ...
  bimo_resolved: {
    ...
    speakerRole: 'Murid Pembuat Jam (Kelas 4)',
    portrait: 'boy_glasses',
    text: 'Halo Ezzel! Aku sudah tidak takut lagi. Kesalahpahamanku dengan Kakek Ranu sudah selesai, dan aku belajar memaafkan diriku sendiri. Terima kasih sudah membantuku dengan tulus!',
    thoughtBubble: 'Kakek Ranu dan aku kembali saling percaya... hatiku rasanya sangat lega!',
    emotionAura: 'gembira',
  },
  ...
  chat_ranu_bimo_ranu: {
    ...
    portrait: 'old_man',
    text: 'Ha! Lihat siapa yang datang! Ezzel! Bimo anak pintar ini sedang memperlihatkan rancangan roda gigi jembatan baru. Kakek bersyukur kesalahpahaman kemarin segera lurus. Sekarang kakek selalu mengingatkan diri sendiri untuk menarik napas dan tidak membentak saat sedang lelah!',
  ...
  chat_ranu_bimo_bimo: {
    ...
    portrait: 'boy_glasses',
    text: 'Dan aku belajar untuk tidak langsung berprasangka buruk jika Kakek Ranu bersuara tegas! Kami saling mendengarkan sekarang, dan roda gigi jembatan ini berputar begitu mulus!',
